...
import { getTitlesAds } from "../../services/getApis";
...
export default function GeradorAds() {
  ...
  async function onSubmit() {
    ...
    getTitlesAds(company, resume, audience, keywords.toString(), avoidKeywords.toString())
      .then((res) => {
        // console.log(res);
    ...
    getDescriptionsAds(company, resume, audience, keywords.toString(), avoidKeywords.toString())
      .then((res) => {
        // console.log(res);
